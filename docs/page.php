<?php
  $topicHeadings = array(
    ...
    "Functional Requirements" => array (
      ...
      "FR-5 On login a confidentiality notice should be displayed",
    ...
    "Non-Functional Requirements" => array (
      "NFR-1 Database access should be secure",
      "NFR-2 The database should be modified to include login fields",
      "NFR-3 Login should be secured",
      "NFR-4 Look and feel should match parent website",
    ...
    "Use Cases" => array (
      ...
      "UC-5 On login a confidentiality notice should be displayed",
